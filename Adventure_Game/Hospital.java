...
public class Hospital {
    ...
    public Hospital(Player player){
        ...
        Slowprint.slowPrintln("As you're finally free of the dog you head for the door leading to the stairways up. However, when you get to the door you see that there is some sort of lock to open it, like a riddle.");
        System.out.println("");
